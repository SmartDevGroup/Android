...
public class LivingRoom extends AppCompatActivity
    ...
    public void onBackPressed() {
        Intent intent = new Intent(LivingRoom.this, Home.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.kitchen) {
            ...
            Intent intent = new Intent(LivingRoom.this, Main.class);
            startActivity(intent);
            overridePendingTransition(R.anim.slidein, R.anim.slideout);finish();
        }
    ...
    private GestureDetector initGestureDetector() {
        return new GestureDetector(new GestureDetector.SimpleOnGestureListener() {
            ...
            private LivingRoom.SwipeDetector detector = new LivingRoom.SwipeDetector();
